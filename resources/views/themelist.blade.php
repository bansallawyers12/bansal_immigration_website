...
<div class="single_package"> 
	<div class="inner_single_package">
		<div class="container-fluid">
			<div class="row"> 
				<div class="list_image">
					<img src="{!! asset('img/Frontend/img/rajastan_img.jpg') !!}" class="img-fluid" alt=""/>
		...
		?>
					<h2>{{@$dest->data->themedetail->name}} Tour Packages</h2>
					<article data-readmore="" aria-expanded="false" id="rmjs-1" class="read-more-fade" style="">  
					<?php echo htmlspecialchars_decode(stripslashes(@$dest->data->themedetail_detail->description)); ?>
					</article>
				...
				<div class="custom-search-input-2 inner-2">
					...
					<div class="filterpanel" id="filters_col">
						...
						<input id="mslug" type="hidden" value="">
						<input id="tslug" type="hidden" value="{{$slug}}">
						...
						<div class="filter_type themes_filter">
							...
							@foreach($filterlist->data->holidaytypes as $holidaytypes)		
								...
								<li>
									<label>
										<input dataname="{{@$holidaytypes->name}}" <?php if($slug == $holidaytypes->slug){ echo 'checked'; } ?> value="{{@$holidaytypes->id}}" name="themes" type="checkbox" class="icheck myListicheck">{{@$holidaytypes->name}} <small>({{@count(@$countdocname)}})</small>
									</label>
								</li>
							@endforeach	
							</ul> 
				...
				<div class="row">
					...
					<div id="mloader" style="position: fixed;left: 45%;padding: 20px;top: 40%;opacity: 0.5;border: 1px solid rgb(102, 102, 102);z-index: 100;background-color: rgb(255, 255, 255);display: none;"><img src="{!! asset('img/loader.gif') !!}" alt="Loading"></div>
