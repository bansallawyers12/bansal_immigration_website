                                ...
                                <table role="presentation" style="width:100%;border-collapse:collapse;border:0;border-spacing:0;">
                                    <tr>
                                        <td style="width:260px;padding:0;vertical-align:top;color:#153643;">
                                            ...
                                            <?php if( isset($details['inperson_address'])  && $details['inperson_address'] != "") { ?>
                                            <p style="margin:0 0 12px 0;font-size:16px;line-height:24px;font-family:Arial,sans-serif;"><strong>Location</strong></p>
                                            <p style="margin:0 0 12px 12px;font-size:16px;line-height:24px;font-family:Arial,sans-serif;">• <strong>In-person:</strong> {{ $details['inperson_address'] }}</p>
                                            <?php }?>
                                    ...
                                    <tr>
                                        <td style="width:260px;padding:0;vertical-align:top;color:#153643;">
                                            <p style="margin:0 0 12px 12px;font-size:16px;line-height:24px;font-family:Arial,sans-serif;">
                                                ...
                                                <a href="{{ url('/email-verify-token/'.base64_encode(convert_uuencode($details['client_id'])) ) }}" style="background-color: #4CAF50;border: none;color: white;padding: 7px 16px;text-align: center;text-decoration: none;display: inline-block;font-size: 16p;cursor: pointer;border-radius: 4px;">Verify Email</a>
                                                 or if you are already verified,Pls ignore this
                                            </p>
                                            <p style="margin:0 0 12px 0;font-size:16px;line-height:24px;font-family:Arial,sans-serif;">
                                                You can also update your details by clicking this link. <a href="{{ url('/verify-dob/'.base64_encode(convert_uuencode($details['client_id'])) ) }}">Update Detail</a>
                                            </p>

                                            <p style="margin:0 0 12px 0;font-size:16px;line-height:24px;font-family:Arial,sans-serif;">If your payment is not done,Please use below payment link - <a target="_blank" href="https://{{$details['host']}}/stripe/{{$details['appointment_id']}}" style="color:#ee4c50;text-decoration:underline;">Payment link</a></p>
