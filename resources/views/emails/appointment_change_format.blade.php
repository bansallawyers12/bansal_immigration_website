                ...
                <tr>
                  <td style="padding:0 0 36px 0;color:#153643;">
                    ...
                    <p style="margin:0;font-size:16px;line-height:24px;font-family:Arial,sans-serif;">
                        If you want to verify your email address Pls click here <a href="{{ url('/email-verify-token/'.base64_encode(convert_uuencode($details['client_id'])) ) }}" style="background-color: #4CAF50;border: none;color: white;padding: 15px 32px;text-align: center;text-decoration: none;display: inline-block;font-size: 16px;margin: 4px 2px;cursor: pointer;border-radius: 4px;">Verify Email</a>
                         or if you are already verified,Pls ignore this
                    </p>
                    <p style="margin:0;font-size:16px;line-height:24px;font-family:Arial,sans-serif;">If you want to update your detail Please click at this link <a href="{{ url('/verify-dob/'.base64_encode(convert_uuencode($details['client_id'])) ) }}">Update Detail</a>
                    </p>
                      ...
                      <tr>
                        <td style="width:260px;padding:0;vertical-align:top;color:#153643;">
                          ...
                          <p style="margin:0;font-size:16px;line-height:24px;font-family:Arial,sans-serif;">Email : {{ $details['email'] }}</p>
                           <?php if( isset($details['appointment_details'])  && $details['appointment_details'] != "") { ?>
                            <p style="margin:5px;font-size:16px;line-height:24px;font-family:Arial,sans-serif;">Appointment details : {{ $details['appointment_details'] }}</p>
                            <?php }?>
                        </td>
                        ...
                        <td style="width:260px;padding:0;vertical-align:top;color:#153643;">
                          ...
                          <p style="margin:5px;font-size:16px;line-height:24px;font-family:Arial,sans-serif;">In Person Address : {{ $details['inperson_address'] }}</p>
                          <?php }?>
