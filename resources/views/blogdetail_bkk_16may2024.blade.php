			...
			<div class="row"> 
				<div class="col-12">
					<div class="inner_blog">
						...
						<!--<a href="<?php echo URL::to('/'); ?>/blogs/{{@$list->slug}}"><img src="https://bansalimmigration.com.au/public/img/blog/{{@$blogdetailists->image}}"></img></a>--> 
						{{--@endif--}}
                        ...
                        if(isset($blogdetailists->image) && $blogdetailists->image != ""){
                            ...
                            if( strtolower($extension) == 'mp4' ){
                               $src = 'https://bansalimmigration.com.au/public/img/blog/'.$blogdetailists->image.'?autoplay=1&mute=1';
                                ?>
                                <iframe width="420" height="315" src="<?php echo $src;?>"></iframe>
                            <?php
                            } else if(strtolower($extension) == 'pdf') {
                                $pdfUrl = 'https://bansalimmigration.com.au/public/img/blog/'.$blogdetailists->image;
                                ?>
                        ...
                        <br><a target="_blank" href="https://bansalimmigration.com.au/public/img/blog/{{@$blogdetailists->pdf_doc}}">Click Here To Open PDF/Video</a> 
						@endif
					</div>
				</div>
			</div>
