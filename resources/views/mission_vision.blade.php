...
<section class="currency-calculator-area section-padding-50 bg-img bg-overlay" style="background-image: url({!! asset('img/Frontend/bg-2.jpg') !!}); padding-top:40px">
	<div class="container">
		<div class="row">
			<div class="col-12">
				...
				<div class="about-content mb-50">
					<div>
						<p style="line-height:16px; color:black">
							<img id="ContentPlaceHolder2_Image1" align="left" src="{!! asset('img/Frontend/73202063430employer.jpg') !!}" style="border-radius:20px; margin-right:20px; margin-bottom:20px; width:400px" />
