  ...
  <a href="tel:<?php echo @\App\ThemeOption::where('meta_key','phone')->first()->meta_value; ?>"
    ...
    <?php echo @\App\ThemeOption::where('meta_key','phone')->first()->meta_value; ?>
					...
					<div class="top-headline headline_right">
						<div class="single-contact-info">
							<ul>
                                <li><a style="color:#1E1755 !important" href="<?php echo URL::to('/'); ?>/pr-calculator">PR Point Calculator</a></li>
								<li><a style="color:#1E1755 !important" href="<?php echo URL::to('/'); ?>/postcode-checker">Postcode Checker</a></li>
                                <li><a style="color:#1E1755 !important" href="<?php echo URL::to('/'); ?>/student-visa-financial-calculator">Student visa Funds calculator</a></li>
