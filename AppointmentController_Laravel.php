...
class AppointmentController extends Controller
{
    ...
    public function index(Request $request)
    {
        try {
            ...
            return view('appointments.index', compact('appointments', 'statistics', 'search', 'dateSearch', 'status', 'perPage'));
    ...
    /**
     * Dashboard widget - get recent appointments
     */
    public function dashboardWidget()
    {
        try {
            $recentAppointments = $this->apiService->getAppointments(['per_page' => 5]);
            $statistics = $this->apiService->getStatistics();
            
            return view('appointments.dashboard-widget', compact('recentAppointments', 'statistics'));
        } catch (Exception $e) {
            return view('appointments.dashboard-widget', [
                'recentAppointments' => ['error' => $e->getMessage()],
